...
;(function ( $, window, document, undefined ) {
	...
	Timeline.prototype._create = function () {		
		var $timelineWrapper = '<div class="timeline"></div>',
            $prevNextWrapper = '<div class="timeline-navigation-btns"></div>',
		...
		if (this.settings.useNavBtns == true || this.settings.useScrollBtns == true) {
            ...
            $timeline.parent().append($prevNextWrapper);
			...
			// If only the useNavBtns is true...	 
				...
				this.$element.find('.timeline-navigation-btns').append($prevButton).append($nextButton);
	...
	Timeline.prototype._timelineComponents = function (timelineComponents) {
        ...
        console.info(timelineComponents['timelineWrapper'].parent())
		timelineComponents['timelineNavigationBtns'] = timelineComponents['timelineWrapper'].parent().parent().find('.timeline-navigation-btns');
	};
	...
	Timeline.prototype._setup = function (self, timelineComponents, timelineTotalWidth) {
		...
		this.$element
			...
			.on('click.'+this._name, '.timeline-navigation-btns a', $.proxy(function() {
				event.preventDefault();
				var $this = $(event.target);
				this._timelineComponents(timelineComponents);
				timelineTotalWidth = this._setTimelineWidth(timelineComponents);
	...
	Timeline.prototype._buttonStates = function (timelineComponents, translateValue, totalTranslateValue){
        console.info(timelineComponents['timelineNavigationBtns']);
		var nextButton = timelineComponents['timelineNavigationBtns'].find('.next'),
			prevButton = timelineComponents['timelineNavigationBtns'].find('.prev'),
