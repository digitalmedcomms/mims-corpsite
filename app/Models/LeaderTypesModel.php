...
class LeaderTypesModel extends Model
{
    ...
    function listing($input){
        ...
        foreach($query->getResult('array') as $result){
            ...
            $item['action'] .= '<a style="padding: 2px 12px;font-size: 12px;" class="btn btn-primary" href="'. base_url("admin/leader-types/edit/" . $result['id']).'" title="Edit"><i class="fa fa-edit"></i> Edit</a>';
            $item['action'] .= '</div>';
