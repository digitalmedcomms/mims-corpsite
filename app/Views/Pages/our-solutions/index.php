            ...
            <div class="container">
                ...
                <div class="section-three-cols">
                    <div class="col-item wow fadeIn" data-wow-delay="0.5s">
                        ...
                        <div class="buttons">
                            <a href="<?php echo base_url('our-solutions/for-hcp#drug-references-and-guidelines'); ?>" class="btn btn-secondary">Read More <i class="fa fa-arrow-right"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="col-item wow fadeIn" data-wow-delay="1.1s">
                        ...
                        <div class="buttons">
                            <a href="<?php echo base_url('our-solutions/for-hcp#professional-development'); ?>" class="btn btn-secondary">Read More <i class="fa fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="institution-container">
                    <div class="section-two-cols">
                        <div class="col-item wow fadeIn" data-wow-delay="0.5s">
                            ...
                            <div class="item-details">
                                <div class="item-title text-blue">Clinical Decision Solutions</div>
                                <div class="item-desc text-grayish-blue">
                        ...
                        <div class="col-item wow fadeIn" data-wow-delay="1s">
                            ...
                            <div class="item-details">
                                ...
                                <div class="buttons">
                                    <a href="<?php echo base_url('our-solutions/for-healthcare-institutions#hcp-recruitment'); ?>" class="btn btn-secondary">Read More</a>
                                </div>
                            </div>
                        </div>
                    </div>
