                    ...
                    <div class="card card-primary card-outline card-outline-tabs">
                        ...
                        <div class="card-body">
                            <div class="float-right d-none d-md-block mb-4">
                                <a href="<?php echo base_url('admin/offices/add'); ?>" class="btn btn-primary rounded btn-custom btn-block waves-effect waves-light">Add Office</a>
                            </div>
                            <div class="table-responsive">
                                <table class="cs_datatable table table-bordered table-striped cell-border" >
                                    <thead>
                                        <tr>
                                            <th>Name</th>
                                            <th class="text-" style="width: 120px;">Country</th>
                                            <th class="text-" style="width: 220px;">Contact Info</th>
