...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            <!-- Main row -->
            <form id="form_safe" action="<?php echo base_url('admin/news-updates/posts/update/' . $post['id']); ?>" method="post">
                ...
                <div class="row">
                    <div class="col-md-8 col-lg-8 col-xl-8">
                        ...
                        <div class="card card-primary card-outline card-outline-tabs">
                            ...
                            <div class="card-body">
                                <input type="hidden" id="id" name="id" class="form-control form-input" value="<?php echo $post['id']; ?>">
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <label for="">Title</label>
                                            <textarea name="title" id="title" rows="3" class="form-control"><?php echo set_value('title', $post['title']); ?></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <div id="postSlug"><?php echo $post['slug']; ?></div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <textarea name="short_description" id="short_description" rows="3" class="form-control"><?php echo set_value('short_description', $post['short_description']); ?></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="content" id="content" class="form-control" ><?php echo set_value('content', $post['content']); ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="post_date" id="post_date" class="form-control datepicker" value="<?php echo set_value('post_date', date("m/d/Y", strtotime($post['date']))); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <select name="status" id="status" class="form-control selectpicker" data-title="Select post status">
                                                <option value="20" <?php echo set_value('status', $post['status']) == 20 ? 'selected' : '';?>>Draft</option>
                                                <option value="10" <?php echo set_value('status', $post['status']) == 10 ? 'selected' : '';?>>Published</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 text-center">
                                                    <img data-toggle="modal" data-target="#file_manager_image" data-bs-field="#image_path" data-bs-image-type="input" data-bs-item-id="#featuredImg" data-bs-input-id="#image_id" id="featuredImg" src="<?php echo !empty(set_value('image_path', $post['featured_img_path'])) ? base_url() . set_value('image_path', $post['featured_img_path']) : base_url('assets/admin/img/default-image.png'); ?>" alt="" class="img-fluid img-thumbnail" style="max-width: 100%;border: none; padding: 0;">
                                                    <input type="hidden" name="image_id" id="selected_img_file_id" value="<?php echo set_value('image_id', $post['featured_img_id']); ?>">
                                                    <input type="hidden" name="image_path" id="image_path" value="<?php echo set_value('image_path', $post['featured_img_path']); ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
